...
$(document).ready(function(e) {
	...
	function googleMap() {
		...
		if(map_canvas.length == 0)
			return;
		var map;
		var myLatlng = new google.maps.LatLng(-23.51851224958816,-46.77359182327882);
		var center = new google.maps.LatLng(-23.51851224958816,-46.77359182327882);
		function mapInitialize() {
			...
			var infowindow = new google.maps.InfoWindow({content:'<strong>Padaria ABC</strong><br>Av. São José, 38 - Osasco<br>'});
